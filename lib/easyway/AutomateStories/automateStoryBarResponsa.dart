...
class AutomateStoryBarResponsa extends StatefulWidget {
  const AutomateStoryBarResponsa({Key? key, required this.title})
      : super(key: key);

  final String title;

  @override
  State<AutomateStoryBarResponsa> createState() =>
      _AutomateStoryBarResponsaState();
}

class _AutomateStoryBarResponsaState extends State<AutomateStoryBarResponsa> {
  String description = "";
  ...
  Widget build(BuildContext context) {
    ...
    String url = "https://www.instagram.com/bar.responsa/";
    String local = "Bar Responsa";
    int price = 0;
    int year = 2024;
...
/////////////////////////////////////////////////////////////////////
    ...
    //
    List<String> third2hartistAndHour =
        separateBarra(hasDescription ? thirdTerms[3] : "");
    //
    String third2artist = hasDescription ? third2hartistAndHour[0] : "";
...
//
    ...
    String sixthHour = removeH(hasDescription ? sixthartistAndHour[1] : "");
//
