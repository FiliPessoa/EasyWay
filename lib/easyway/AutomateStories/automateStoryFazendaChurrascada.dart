...
class AutomateStoryFazendaChurrascada extends StatefulWidget {
  const AutomateStoryFazendaChurrascada({Key? key, required this.title})
      : super(key: key);

  final String title;

  @override
  State<AutomateStoryFazendaChurrascada> createState() =>
      _AutomateStoryFazendaChurrascadaState();
}

class _AutomateStoryFazendaChurrascadaState
    extends State<AutomateStoryFazendaChurrascada> {
  String description = "";
  ...
  Widget build(BuildContext context) {
    ...
    String url = "https://www.instagram.com/fazendachurrascadabsb/";
    String local = "Fazenda Churrascada";
    int price = 0;
    int year = 2024;
...
////////////////////////////////////////////////////////////////////////
    List<String> fifthTerms = separateLines(forthParagraph);
...
////////////////////////////////////////////////////////////////////////
    ...
    // //
    List<String> sixthStartHour =
        separateHour(hasDescription ? sixthartistAndHour[1] : "");
    String sixthHour = sixthStartHour[0];
    String sixthMinute = hasDescription ? sixthStartHour[1] : "";
//
    ...
    int sixthIntMinute = hasDescription ? int.parse(sixthHour) : 0;
    String sixthformattedDate =
        '$year-$sixthIntMonth-$sixthIntDay $sixthIntHour:$sixthIntMinute:00';
////////////////////////////////////////////////////////////////////////
    List<String> seventhTerms = separateLines(sixthParagraph);

    List<String> seventhfullDate = separateBarra(seventhTerms[0]);
...
////////////////////////////////////////////////////////////////////////
    String eightParagraph = hasDescription ? paragraphs[6] : "";
    List<String> eightTerms = separateLines(eightParagraph);

    List<String> eightfullDate = separateBarra(eightTerms[0]);
    List<String> eightDate =
        separateDayMonth(hasDescription ? eightfullDate[1] : "");
    String eightDay = removeSpace(hasDescription ? eightDate[0] : "");

    String eightMonth = removeSpace(hasDescription ? eightDate[1] : "");
    //
    List<String> eightartistAndHour =
        separateBarra(hasDescription ? eightTerms[1] : "");
    //
    String eightartist = hasDescription ? eightartistAndHour[0] : "";
    String eighttitle = hasDescription ? eightartist + "no " + local : "";
    // //
    List<String> eightStartHour =
        separateHour(hasDescription ? eightartistAndHour[1] : "");
    String eightHour = eightStartHour[0];
    String eightMinute = hasDescription ? eightStartHour[1] : "";
//
    int eightIntDay = hasDescription ? int.parse(eightDay) : 0;
    int eightIntMonth = hasDescription ? int.parse(eightMonth) : 0;
    int eightIntHour = hasDescription ? int.parse(eightHour) : 0;
    int eightIntMinute = hasDescription ? int.parse(eightMinute) : 0;
    String eightformattedDate =
        '$year-$eightIntMonth-$eightIntDay $eightIntHour:$eightIntMinute:00';
                  ...
                  child: hasDescription
                      ? Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10),
                            Container(child: Text(eighttitle)),
                            Container(child: Text(eightformattedDate)),
                            Container(child: Text(url)),
                            Container(child: Text(local)),
                            Container(child: Text(price as String)),
                          ],
