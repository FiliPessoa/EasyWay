...
class AutomateAbencoadoBar extends StatefulWidget {
  const AutomateAbencoadoBar({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<AutomateAbencoadoBar> createState() => _AutomateAbencoadoBarState();
}

class _AutomateAbencoadoBarState extends State<AutomateAbencoadoBar> {
  String description = "";
  ...
  Widget build(BuildContext context) {
    ...
    String url = "https://www.instagram.com/abencoadobar/";
    String local = "Abençoado Bar";
    String price = "0";
    int year = 2024;
...
// /////////////////////////////////////////////////////////////////////
    ...
    List<String> third2artistAndHour =
        separateBarra(hasDescription ? thirdTerms[3] : "");
    //
    String thirdartist = hasDescription ? thirdartistAndHour[0] : "";
    String third2artist = hasDescription ? third2artistAndHour[0] : "";
    String thirdtitle =
        hasDescription ? thirdartist + "e " + third2artist + "no " + local : "";
    // //
    List<String> thirdFullHour =
        separateHour(hasDescription ? thirdartistAndHour[1] : "");
    String thirdHour = removeH(hasDescription ? thirdFullHour[0] : "");
    String thirdMinute = removeH(hasDescription ? thirdFullHour[1] : "");
//
    ...
    int thirdIntMinute = hasDescription ? int.parse(thirdMinute) : 0;
    String thirdformattedDate =
        '$year-$thirdIntMonth-$thirdIntDay $thirdIntHour:$thirdIntMinute:00';
//     /////////////////////////////////////////////////////////////////////
    ...
    List<String> forth2artistAndHour =
        separateBarra(hasDescription ? forthTerms[3] : "");
    //
    String forthartist = hasDescription ? forthartistAndHour[0] : "";
    String forth2artist = hasDescription ? forth2artistAndHour[0] : "";
    String forthtitle =
        hasDescription ? forthartist + "e " + forth2artist + "no " + local : "";
    // //
...
//
    ...
    String forthformattedDate =
        '$year-$forthIntMonth-$forthIntDay $forthIntHour:$forthMinute:00';
    ///////////////////////////////////////////////////////////////////
    ...
    String fifthMinute = hasDescription ? fifthstarttime[1] : "";
    //
