...
class AutomatePostLondon extends StatefulWidget {
  const AutomatePostLondon({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<AutomatePostLondon> createState() => _AutomatePostLondonState();
}

class _AutomatePostLondonState extends State<AutomatePostLondon> {
  String description = "";
  ...
  Widget build(BuildContext context) {
    ...
    List<String> firstdata = separateWords(firstTerms[0]);
    String placedata = hasDescription ? firstdata[2] : "";
    List<String> data = separateDayMonth(placedata);
    List<String> mes = hasDescription ? removeLetters(data[1]) : [];
    List<String> dia = hasDescription ? removeLetters(data[0]) : [];
    String firstday = hasDescription ? dia[1] : "";
    String firstmonth = hasDescription ? mes[0] : "";
    int firststartHour = 19;
    int firstendHour = 22;
    ...
    String url = "https://www.instagram.com/londonstreetpub/";
    String local = "London Street Pub";
    String price = "19";
                  ...
                  child: hasDescription
                      ? Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10),
                            Container(child: Text(firstTerms[0])),
                            Container(child: Text(firstTerms[1])),
                            Container(child: Text(firstTerms[2])),
                            Container(
                                child: Text(
                                    firstTerms[2] + "com" + firstTerms[1])),
